                ...
                <form action="<?php echo e(route('barang.update', $barang->ID_Barang)); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control select2" name="ID_Kategori" required>
                                ...
                                <?php $__currentLoopData = $kategoribarang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->ID_Kategori); ?>" <?php echo e($barang->ID_Kategori == $kategori->ID_Kategori ? 'selected' : ''); ?>>
                                        <?php echo e($kategori->Kategori_Barang); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="Merek_Barang"
                                value="<?php echo e($barang->Merek_Barang ?? ''); ?>" placeholder="Masukkan Merek barang" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="Harga_Barang"
                                value="<?php echo e($barang->Harga_Barang); ?>" placeholder="Masukkan Harga Barang" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Stok Barang*</label>
                            <input type="number" class="form-control" name="Stok_Barang"
                                value="<?php echo e($barang->Stok_Barang); ?>" placeholder="Masukkan Stok Barang" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="Besar_Satuan"
                                value="<?php echo e($barang->Besar_Satuan ?? ''); ?>" placeholder="Contoh: 1, 1/2" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" name="ID_Satuan" required>
                                ...
                                <?php $__currentLoopData = $satuanbarang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->ID_Satuan); ?>" <?php echo e($barang->ID_Satuan == $satuan->ID_Satuan ? 'selected' : ''); ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="Deskripsi_Barang"
                            value="<?php echo e($barang->Deskripsi_Barang); ?>"
...
</html><?php /**PATH F:\Proyek\Kuliah\Website\skripsi\resources\views/editbarang.blade.php ENDPATH**/ ?>